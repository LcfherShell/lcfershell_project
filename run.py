...
app.config.update(dict( 
    ...
    RECAPTCHA_PUBLIC_KEY = RECAPTCHA['key'], #"6Lfci9QZAAAAAJdzaCsQjOZ6od3Jhr4cNjPxDMUE",
    RECAPTCHA_PRIVATE_KEY = RECAPTCHA['secret'],  #"6Lfci9QZAAAAAC8SHmti-WgDfqdvr4LbSl2xYrwb",
    ...
    MAIL_USE_TLS = False,
    MAIL_USE_SSL = True,
    MAIL_USERNAME = "alfiandecker2@gmail.com",
    MAIL_PASSWORD = "r4MS*y#An'",
